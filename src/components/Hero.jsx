...
import profilePic from "../assets/Ely'sProfilee.jpg";
    ...
    <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2">
            <div className="flex flex-col items-center lg:items-start">
                ...
                <motion.span 
                 ...
                 initial= "hidden"
                 animate= "visible"
                className=" bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text text-2xl tracking-tigh text-transparent">
        ...
        <div className="w-full lg:w-1/2 lg:p-14">
            <div className="flex justify-center">
                ...
                className="rounded-[20px]" src={profilePic} alt="Elymae Pascual" />
            </div>
        </div>
    </div>
</div>
